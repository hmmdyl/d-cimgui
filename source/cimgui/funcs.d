...
extern(C) @nogc nothrow
{
	 ...
	 alias da_igBeginChild = bool function(const char* str_id, const ImVec2 size, bool border, ImGuiWindowFlags flags);
	 ...
	 alias da_igSetScrollFromPosY = void function(float local_y, float center_y_ratio);
	 ...
	 alias da_igGetColorU32 = ImU32 function(ImGuiCol idx, float alpha_mul);
	 ...
	 alias da_igCombo = bool function(const char* label, int* current_item, const(const char*)[] item, int items_count, int popup_max_height_in_items);
	 ...
	 alias da_igDragFloat = bool function(const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, float power);
	 alias da_igDragFloat2 = bool function(const char* label, float[2] v, float v_speed, float v_min, float v_max, const char* format, float power);
	 alias da_igDragFloat3 = bool function(const char* label, float[3] v, float v_speed, float v_min, float v_max, const char* format, float power);
	 alias da_igDragFloat4 = bool function(const char* label, float[4] v, float v_speed, float v_min, float v_max, const char* format, float power);
	 alias da_igDragFloatRange2 = bool function(const char* label, float* v_current_min, float* v_current_max, float v_speed, float v_min, float v_max, const char* format, const char* format_max, float power);
	 alias da_igDragInt = bool function(const char* label, int* v, float v_speed, int v_min, int v_max, const char* format);
	 alias da_igDragInt2 = bool function(const char* label, int[2] v, float v_speed, int v_min, int v_max, const char* format);
	 alias da_igDragInt3 = bool function(const char* label, int[3] v, float v_speed, int v_min, int v_max, const char* format);
	 alias da_igDragInt4 = bool function(const char* label, int[4] v, float v_speed, int v_min, int v_max, const char* format);
	 alias da_igDragIntRange2 = bool function(const char* label, int* v_current_min, int* v_current_max, float v_speed, int v_min, int v_max, const char* format, const char* format_max);
	 alias da_igDragScalar = bool function(const char* label, ImGuiDataType data_type, void* v, float v_speed, const void* v_min, const void* v_max, const char* format, float power);
	 alias da_igDragScalarN = bool function(const char* label, ImGuiDataType data_type, void* v, int components, float v_speed, const void* v_min, const void* v_max, const char* format, float power);
	 alias da_igSliderFloat = bool function(const char* label, float* v, float v_min, float v_max, const char* format, float power);
	 alias da_igSliderFloat2 = bool function(const char* label, float[2] v, float v_min, float v_max, const char* format, float power);
	 alias da_igSliderFloat3 = bool function(const char* label, float[3] v, float v_min, float v_max, const char* format, float power);
	 alias da_igSliderFloat4 = bool function(const char* label, float[4] v, float v_min, float v_max, const char* format, float power);
	 alias da_igSliderAngle = bool function(const char* label, float* v_rad, float v_degrees_min, float v_degrees_max, const char* format);
	 alias da_igSliderInt = bool function(const char* label, int* v, int v_min, int v_max, const char* format);
	 alias da_igSliderInt2 = bool function(const char* label, int[2] v, int v_min, int v_max, const char* format);
	 alias da_igSliderInt3 = bool function(const char* label, int[3] v, int v_min, int v_max, const char* format);
	 alias da_igSliderInt4 = bool function(const char* label, int[4] v, int v_min, int v_max, const char* format);
	 alias da_igSliderScalar = bool function(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power);
	 alias da_igSliderScalarN = bool function(const char* label, ImGuiDataType data_type, void* v, int components, const void* v_min, const void* v_max, const char* format, float power);
	 alias da_igVSliderFloat = bool function(const char* label, const ImVec2 size, float* v, float v_min, float v_max, const char* format, float power);
	 alias da_igVSliderInt = bool function(const char* label, const ImVec2 size, int* v, int v_min, int v_max, const char* format);
	 alias da_igVSliderScalar = bool function(const char* label, const ImVec2 size, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power);
	 ...
	 alias da_igInputFloat2 = bool function(const char* label, float[2] v, const char* format, ImGuiInputTextFlags flags);
	 alias da_igInputFloat3 = bool function(const char* label, float[3] v, const char* format, ImGuiInputTextFlags flags);
	 alias da_igInputFloat4 = bool function(const char* label, float[4] v, const char* format, ImGuiInputTextFlags flags);
	 alias da_igInputInt = bool function(const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags flags);
	 alias da_igInputInt2 = bool function(const char* label, int[2] v, ImGuiInputTextFlags flags);
	 alias da_igInputInt3 = bool function(const char* label, int[3] v, ImGuiInputTextFlags flags);
	 alias da_igInputInt4 = bool function(const char* label, int[4] v, ImGuiInputTextFlags flags);
	 ...
	 alias da_igInputScalar = bool function(const char* label, ImGuiDataType data_type, void* v, const void* step, const void* step_fast, const char* format, ImGuiInputTextFlags flags);
	 alias da_igInputScalarN = bool function(const char* label, ImGuiDataType data_type, void* v, int components, const void* step, const void* step_fast, const char* format, ImGuiInputTextFlags flags);
	 alias da_igColorEdit3 = bool function(const char* label, float[3] col, ImGuiColorEditFlags flags);
	 alias da_igColorEdit4 = bool function(const char* label, float[4] col, ImGuiColorEditFlags flags);
	 alias da_igColorPicker3 = bool function(const char* label, float[3] col, ImGuiColorEditFlags flags);
	 alias da_igColorPicker4 = bool function(const char* label, float[4] col, ImGuiColorEditFlags flags, const float* ref_col);
